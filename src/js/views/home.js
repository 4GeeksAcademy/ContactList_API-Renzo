...
export const Home = () => {
					...
					<div className="card col flex-row" >
						...
						<div className="col-2 mt-4">
							<Link to="/update" state={dataContact}>
								<i className="fa-solid fa-pencil mx-3" style={{color: "#6c757d"}}
									onClick={()=>{
										//Actualizar										
									}} 
								></i>
							</Link>
							<i className="fa-solid fa-trash mx-3" style={{color:"red", cursor:"pointer"}} data-bs-toggle="modal" data-bs-target={"#staticBackdrop-"+contacto.id}></i>
	...
	return <div className="container">
			<h1 className="display-2 text-center mb-5">Agenda Jaimito</h1>
			{
